...
$theme_defaults = array(
    ...
    'theme_end_message'=>'This email has been sent to {email} because subscribed and confirmed on ' . get_option('blogname') . '. <a href="{profile_url}">Click here to modify you subscription or unsubscribe</a>.',
    'theme_categories'=>array('newsletter')
    );
...
<table class="form-table">
    <tr valign="top">
        ...
        <td>
            <?php $controls->text('theme_max_posts', 10); ?> (it defaults to 10 if empty or invalid)
        </td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        <th>End message</th>
        <td>
            <?php $controls->text('theme_end_message', 70); ?>
        </td>
    </tr>
    <tr valign="top">
