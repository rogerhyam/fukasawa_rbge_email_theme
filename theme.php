...
<html>
    ...
    <body style="font:normal 11px helvetica,sans-serif;">
        ...
        <table style="background:#ffffff" width="600" align="center" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="padding-bottom: 10px; padding-top:15px;"><a href="<?php echo get_site_url() ?>"><img style="width: 575px; margin-top: 10px; margin-left:5px; margin-right:15px;" src="<?php echo $theme_url; ?>/email_header.png" alt=""></a></td>
            </tr>
                        ...
                        <tr>
                            <td style="background:#ffffff">
                                    ...
                                    <table style="width:100%;color:#456;font:normal 12px/1.5em helvetica,sans-serif;margin:15px 0 0 0;padding:0 0 15px 0;border-bottom:1px dotted #e1e2e3">
                                        ...
                                        <tbody><tr>
                                                ...
                                                <td style="width:100%;padding:0 10px 0 0;vertical-align:top">
                                                    ...
                                                    <p style="font-family:arial,sans-serif;color:#006750;font-size:20px;line-height:22px;margin:0;padding:0"><strong><a target="_tab" href="<?php echo get_permalink(); ?>" style="color:#006750;text-decoration:none" target="_blank"><?php the_title(); ?></a></strong></p>
                                ...
                                <p style="color:#456;font-family:arial,sans-serif;font-size:12px;line-height:1.6em;font-style:italic;margin:0 0 15px 0;padding:0">
                                    <?php echo $theme_options['theme_end_message']; ?>
                                </p>
                            </td>
                        </tr>
